...
public class UserCrudRunner {
    ...
    void shouldGetUserSuccessfully() {
        // Consultamos un ID fijo de JSONPlaceholder ("2") para validar la respuesta completa
    ...
    void shouldUpdateUserSuccessfully() {
        // JSONPlaceholder no persiste los registros creados por POST en su base de datos.
    ...
    void shouldDeleteUserSuccessfully() {
        // Realizamos el DELETE sobre el usuario existente con ID 2 por consistencia.
        Integer targetId = 2;
